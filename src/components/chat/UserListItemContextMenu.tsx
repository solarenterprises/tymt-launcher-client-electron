...
const UserListItemContextMenu = ({
  user,
  view,
  setView,
  contextMenuPosition,
  page,
}: IPropsUserListItemContextMenu) => {
  ...
  //         instructions: [
  //           SyncEventNames.UPDATE_CONTACT_LIST,
  //           SyncEventNames.UPDATE_FRIEND_LIST,
  //         ],
  //         is_to_self: false,
  //       };
  ...
  //           SyncEventNames.UPDATE_CONTACT_LIST,
  //           SyncEventNames.UPDATE_FRIEND_LIST,
  //           SyncEventNames.UPDATE_BLOCK_LIST,
  //         ],
  //         is_to_self: true,
  //       };
