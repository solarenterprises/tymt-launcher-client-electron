...
type ICurrentChatroomMember = any;
    ...
    <Box key={`${index}-${new Date().toISOString()}`}>
      ...
      >
        ...
        >
          ...
          {invited &&
            myInfoStore?._id !== member._id &&
            !(!myInfoStore?.isAdmin && !currentChatroomStore?.isPrivate) && (
              <MemberRemoveButton member={member} />
            )}
          {!invited &&
            myInfoStore?._id !== member._id &&
            !(!myInfoStore?.isAdmin && !currentChatroomStore?.isPrivate) && (
