  ...
  const getFileDetailsFromFileName = (fullFileName: string) => {
    try {
      ...
      const filenameWithoutExtension = extension
        ? fullFileName.slice(0, -(extension.length + 1))
        : fullFileName;
    ...
    <>
      <Box
        className={`fs-14-regular white ${
          isSender ? "bubble" : "bubble-partner"
        } ${
          isLastMessage
            ? roomMode
              ? "br-20-20-20-0"
          ...
          >
            ...
            >
              <FileIcon
                ...
                // {...defaultStyles[fileDetail.extension]}
              />
            </Box>
            <Box
