...
// import { supportChains } from "../../const/wallet/SupportTokens";
...
// import { IBalanceList, ICurrencyList, ICurrentChain, ICurrentCurrency, IPriceList, IWallet } from "../../types/wallet/WalletTypes";
...
const ChooseChainDrawer = ({ view, setView }: IPropsChooseChainDrawer) => {
  ...
  const currentChainStore = { chain: "Ethereum" };
